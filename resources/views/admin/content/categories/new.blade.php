...
@section('content')
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Categories in <span class="text-info">{{ $section->name }}</span> section
            </h1>
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item active">Add Category for
                    ...
                    <div class="row my-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                id="title" value="{{ old('title') }}" placeholder="Category short description">
                            @error('title')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
