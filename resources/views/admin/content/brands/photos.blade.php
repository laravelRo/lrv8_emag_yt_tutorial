...
@section('content')
    ...
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Photo Galery for <span class="text-info">{{ $brand->name }}</span></a>
            </h1>
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item active">{{ $brand->name }} Photo Galery</li>
                <li class="breadcrumb-item"><a href="{{ route('brands.edit', $brand->id) }}">Edit Brand <span
                            class="text-info">{{ $brand->name }}</span></a>
                </li>
            </ol>

            <div class="row">
                @livewire('admin.photos-upload', ['model'=>$brand, 'path'=>'brands/'.$brand->id.'/'])
            </div>
